...
<body>
	<center>
		<form action="fundTranser">
			Enter your A\c No : <input type="text" name="acno1"> <br>
			<br> Enter your pin : <input type="password" name="pin">
			<br> <br> Enter Amount : <input type="text" name="amount">
			<br>
			<br> Enter your Beneficiary No : <input type="text" name="acno2">
			<br> <br> <input type="submit" value="FundTransfer">
		</form>
		<br>
